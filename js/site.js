(function () {
  ...
  function renderAbout() {
    return [
      ...
      '</div></div><div class="container founders-vision"><div class="founders-vision__copy"><p class="eyebrow"><span></span>OUR FOUNDERS</p><h3>A Godly Vision</h3><p>The Hermanus Christian Academy was founded by Dr Nealie and Mrs Veronica Ross around 1992. Their dream was to help underprivileged children. They started with a couple of children and it grew from there to just over 200 learners at present. They are still very involved in the school and Dr. Ross is the Chairman of the Trust.</p></div><div class="founders-vision__media"><img src="assets/images/photos/ABOUT-FOUNDERS-VISION.jpg?v=20260914a" alt="HCA founders Dr Nealie and Mrs Veronica Ross" width="900" height="1200" loading="lazy"></div></div></section>',
